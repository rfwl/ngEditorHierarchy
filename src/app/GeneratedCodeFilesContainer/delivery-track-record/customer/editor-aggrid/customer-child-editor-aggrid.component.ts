  ...
  import { CustomerChildEditorFormComponent } from '../editor-form/customer-child-editor-form.component'



  @Component({
    selector: "customer-child-editor-aggrid", 
templateUrl: './customer-child-editor-aggrid.component.html', 

styleUrls: ['./customer-child-editor-aggrid.component.scss'] 

}) 

  export class CustomerChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'Customers', str, 'modal-xl')
    }
...
{ field: "Phone", tooltipField:  "Phone", headerName: "Phone", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(CustomerChildEditorFormComponent, config)
