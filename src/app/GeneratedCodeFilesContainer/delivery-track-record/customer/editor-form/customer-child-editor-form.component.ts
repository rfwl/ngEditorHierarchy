  ...
  @Component({
    selector: "customer-child-editor-form", 
templateUrl: './customer-child-editor-form.component.html', 

styleUrls: ['./customer-child-editor-form.component.scss'] 

}) 

    export class CustomerChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'Customer', str, 'modal-xl')
    }
