  ...
  @Component({
    selector: "customer-child-editor-ptable",

templateUrl: './customer-child-editor-ptable.component.html', 

styleUrls: ['./customer-child-editor-ptable.component.scss'] 

}) 

  export class CustomerChildEditorPTableComponent implements OnInit {
