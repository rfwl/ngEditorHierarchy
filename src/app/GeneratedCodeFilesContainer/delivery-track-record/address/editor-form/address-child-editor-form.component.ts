  ...
  import { DeliveryTrackRecord, EnumSelectorOptionSource, Enum_EditorComponent_Type } from '../../delivery-track-record.model'
  ...
  @Component({
    selector: "address-child-editor-form", 
templateUrl: './address-child-editor-form.component.html', 

styleUrls: ['./address-child-editor-form.component.scss'] 

}) 

    export class AddressChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'Address', str, 'modal-xl')
    }
...
get Address1() { return this.editorForm.get('Address1')  }
get Address2() { return this.editorForm.get('Address2')  }
