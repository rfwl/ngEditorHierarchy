  ...
  import { AddressChildEditorFormComponent } from '../editor-form/address-child-editor-form.component'



  @Component({
    selector: "address-child-editor-aggrid", 
templateUrl: './address-child-editor-aggrid.component.html', 

styleUrls: ['./address-child-editor-aggrid.component.scss'] 

}) 

  export class AddressChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'Addresses', str, 'modal-xl')
    }
...
{ field: "Address1", tooltipField:  "Address1", headerName: "Address1", flex: 1 }, 
{ field: "Address2", tooltipField:  "Address2", headerName: "Address2", flex: 1 }, 
{ field: "Suburb", tooltipField:  "Suburb", headerName: "Suburb", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(AddressChildEditorFormComponent, config)
