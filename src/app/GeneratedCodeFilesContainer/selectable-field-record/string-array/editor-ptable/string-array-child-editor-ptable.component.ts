  ...
  @Component({
    selector: "string-array-child-editor-ptable",

templateUrl: './string-array-child-editor-ptable.component.html', 

styleUrls: ['./string-array-child-editor-ptable.component.scss'] 

}) 

  export class StringArrayChildEditorPTableComponent implements OnInit {
