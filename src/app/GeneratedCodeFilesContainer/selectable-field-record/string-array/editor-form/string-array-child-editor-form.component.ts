...
import { SelectableOptionRecord } from '../../../selectable-option-record/selectable-option-record.model'
  ...
  @Component({
    selector: "string-array-child-editor-form", 
templateUrl: './string-array-child-editor-form.component.html', 

styleUrls: ['./string-array-child-editor-form.component.scss'] 

}) 

    export class StringArrayChildEditorFormComponent implements OnInit {
...
CheckboxFromRecordList_SelectableOptionRecord_Options: any[] =[]
CheckboxFromRecordList_PersonFullName_SelectableOptionRecord_Options: any[] =[]
...
try {
  this.store.dispatch(SelectableOptionRecordActionTypes.loadSelectableOptionRecords())
  this.store.pipe(select(selectAllSelectableOptionRecords)).subscribe (entLst => {
    this.CheckboxFromRecordList_SelectableOptionRecord_Options = entLst.map<SelectableOptionRecord>(ent => {
      try {
        let ent1 = deepClone(ent)
        return SelectableOptionRecord.createFrom(ent1)
      } catch(_){ return null}
...
try {
  this.store.dispatch(SelectableOptionRecordActionTypes.loadSelectableOptionRecords())
  this.store.pipe(select(selectAllSelectableOptionRecords)).subscribe (entLst => {
    this.CheckboxFromRecordList_PersonFullName_SelectableOptionRecord_Options = entLst.map<SelectableOptionRecord>(ent => {
      try {
        let ent1 = deepClone(ent)
        return SelectableOptionRecord.createFrom(ent1)
      } catch(_){ return null}
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'StringArray', str, 'modal-xl')
    }
...
CheckboxFromValueArray: [''], 
CheckboxFromLabeledValueArray: [''], 
CheckboxFromObjectArray: [''], 
CheckboxFromRecordList: [''], 
CheckboxFromRecordList_PersonFullName: [''], 
...
get CheckboxFromValueArray() { return this.editorForm.get('CheckboxFromValueArray')  }
get CheckboxFromLabeledValueArray() { return this.editorForm.get('CheckboxFromLabeledValueArray')  }
get CheckboxFromObjectArray() { return this.editorForm.get('CheckboxFromObjectArray')  }
get CheckboxFromRecordList() { return this.editorForm.get('CheckboxFromRecordList')  }
get CheckboxFromRecordList_PersonFullName() { return this.editorForm.get('CheckboxFromRecordList_PersonFullName')  }
