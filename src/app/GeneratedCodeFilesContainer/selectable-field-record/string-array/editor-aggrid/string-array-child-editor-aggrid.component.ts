  ...
  import { StringArrayChildEditorFormComponent } from '../editor-form/string-array-child-editor-form.component'



  @Component({
    selector: "string-array-child-editor-aggrid", 
templateUrl: './string-array-child-editor-aggrid.component.html', 

styleUrls: ['./string-array-child-editor-aggrid.component.scss'] 

}) 

  export class StringArrayChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'StringArrays', str, 'modal-xl')
    }
...
cellRenderer: "dataTypeArrayCellRenderer", cellRendererParams: { inputType: "text" } }, 
{ field: "CheckboxFromRecordList_PersonFullName", tooltipField:  "CheckboxFromRecordList_PersonFullName", headerName: "CheckboxFromRecordList PersonFullName", flex: 1,
cellRenderer: "dataTypeArrayCellRenderer", cellRendererParams: { inputType: "text" } }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(StringArrayChildEditorFormComponent, config)
