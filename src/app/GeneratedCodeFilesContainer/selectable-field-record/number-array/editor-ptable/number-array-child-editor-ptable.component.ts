  ...
  @Component({
    selector: "number-array-child-editor-ptable",

templateUrl: './number-array-child-editor-ptable.component.html', 

styleUrls: ['./number-array-child-editor-ptable.component.scss'] 

}) 

  export class NumberArrayChildEditorPTableComponent implements OnInit {
