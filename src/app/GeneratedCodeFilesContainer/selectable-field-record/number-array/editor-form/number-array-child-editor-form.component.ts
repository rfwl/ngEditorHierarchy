...
import { SelectableOptionRecord } from '../../../selectable-option-record/selectable-option-record.model'
  ...
  @Component({
    selector: "number-array-child-editor-form", 
templateUrl: './number-array-child-editor-form.component.html', 

styleUrls: ['./number-array-child-editor-form.component.scss'] 

}) 

    export class NumberArrayChildEditorFormComponent implements OnInit {
...
try {
  ...
  this.store.pipe(select(selectAllSelectableOptionRecords)).subscribe (entLst => {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'NumberArray', str, 'modal-xl')
    }
