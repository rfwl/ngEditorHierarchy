  ...
  @Component({
    selector: "number-value-child-editor-ptable",

templateUrl: './number-value-child-editor-ptable.component.html', 

styleUrls: ['./number-value-child-editor-ptable.component.scss'] 

}) 

  export class NumberValueChildEditorPTableComponent implements OnInit {
