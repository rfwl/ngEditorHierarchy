  ...
  import { NumberValueChildEditorFormComponent } from '../editor-form/number-value-child-editor-form.component'



  @Component({
    selector: "number-value-child-editor-aggrid", 
templateUrl: './number-value-child-editor-aggrid.component.html', 

styleUrls: ['./number-value-child-editor-aggrid.component.scss'] 

}) 

  export class NumberValueChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'NumberValues', str, 'modal-xl')
    }
...
{ field: "RadioFromRecordList", tooltipField:  "RadioFromRecordList", headerName: "RadioFromRecordList", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(NumberValueChildEditorFormComponent, config)
