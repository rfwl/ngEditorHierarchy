  ...
  @Component({
    selector: "string-value-child-editor-ptable",

templateUrl: './string-value-child-editor-ptable.component.html', 

styleUrls: ['./string-value-child-editor-ptable.component.scss'] 

}) 

  export class StringValueChildEditorPTableComponent implements OnInit {
