  ...
  import { StringValueChildEditorFormComponent } from '../editor-form/string-value-child-editor-form.component'



  @Component({
    selector: "string-value-child-editor-aggrid", 
templateUrl: './string-value-child-editor-aggrid.component.html', 

styleUrls: ['./string-value-child-editor-aggrid.component.scss'] 

}) 

  export class StringValueChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'StringValues', str, 'modal-xl')
    }
...
{ field: "RadioFromValueArray", tooltipField:  "RadioFromValueArray", headerName: "RadioFromValueArray", flex: 1 }, 
{ field: "RadioFromLabeledValueArray", tooltipField:  "RadioFromLabeledValueArray", headerName: "RadioFromLabeledValueArray", flex: 1 }, 
{ field: "RadioFromObjectArray", tooltipField:  "RadioFromObjectArray", headerName: "RadioFromObjectArray", flex: 1 }, 
{ field: "RadioFromRecordList", tooltipField:  "RadioFromRecordList", headerName: "RadioFromRecordList", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(StringValueChildEditorFormComponent, config)
