  ...
  import { EnumSelectorOptionSource } from '../school-teacher.model'
...
import { ContactChildEditorFormComponent } from "../contact/editor-form/contact-child-editor-form.component";
  ...
  @Component({
    selector: "school-teacher-editor-form", 
templateUrl: './school-teacher-editor-form.component.html', 

styleUrls: ['./school-teacher-editor-form.component.scss'] 

}) 


  export class SchoolTeacherEditorFormComponent implements OnInit {
    firestore: Firestore
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'SchoolTeacher', str, 'modal-xl')
    }
    ...
    get editorFormTitle(): string{
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          return 'Create SchoolTeacher'
        case EnumEditorOperationType.Delete:
          return 'Delete SchoolTeacher'
        case EnumEditorOperationType.Update:
          return 'Update SchoolTeacher'
        default:
          return 'Edit SchoolTeacher'
      }
    }
...
get Level() { return this.editorForm.get('Level')  }
get Specialty() { return this.editorForm.get('Specialty')  }
get Qualification() { return this.editorForm.get('Qualification')  }
    ...
    submitEditorForm(editorForm:any){
      ...
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          ...
          // this.store.dispatch(SchoolTeacherActionTypes.createSchoolTeacher({ schoolTeacher: {...this.editedObject } }))
          break
        case EnumEditorOperationType.Delete:
          if(this.parentDataArray && this.parentDataIndex >= 0){
            this.parentDataArray?.splice(this.parentDataIndex,1)
            // moved the next line to Editor AgGrid
            // this.store.dispatch(SchoolTeacherActionTypes.deleteSchoolTeacher({ schoolTeacherId: this.editedObject.id }))
          }
          break
        case EnumEditorOperationType.Update:
          break
