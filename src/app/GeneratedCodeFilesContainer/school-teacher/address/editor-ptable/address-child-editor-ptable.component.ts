  ...
  @Component({
    selector: "address-child-editor-ptable",

templateUrl: './address-child-editor-ptable.component.html', 

styleUrls: ['./address-child-editor-ptable.component.scss'] 

}) 

  export class AddressChildEditorPTableComponent implements OnInit {
