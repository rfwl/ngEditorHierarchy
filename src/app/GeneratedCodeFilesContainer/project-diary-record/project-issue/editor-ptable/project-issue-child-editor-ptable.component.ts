  ...
  @Component({
    selector: "project-issue-child-editor-ptable",

templateUrl: './project-issue-child-editor-ptable.component.html', 

styleUrls: ['./project-issue-child-editor-ptable.component.scss'] 

}) 

  export class ProjectIssueChildEditorPTableComponent implements OnInit {
