  ...
  @Component({
    selector: "project-issue-child-editor-form", 
templateUrl: './project-issue-child-editor-form.component.html', 

styleUrls: ['./project-issue-child-editor-form.component.scss'] 

}) 

    export class ProjectIssueChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectIssue', str, 'modal-xl')
    }
...
get Severeness() { return this.editorForm.get('Severeness')  }
get Duplicable() { return this.editorForm.get('Duplicable')  }
