  ...
  import { ProjectIssueChildEditorFormComponent } from '../editor-form/project-issue-child-editor-form.component'



  @Component({
    selector: "project-issue-child-editor-aggrid", 
templateUrl: './project-issue-child-editor-aggrid.component.html', 

styleUrls: ['./project-issue-child-editor-aggrid.component.scss'] 

}) 

  export class ProjectIssueChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectIssues', str, 'modal-xl')
    }
...
{ field: "Severeness", tooltipField:  "Severeness", headerName: "Severeness", flex: 1 }, 
{ field: "Duplicable", tooltipField:  "Duplicable", headerName: "Duplicable", flex: 1 }, 
...
{ field: "Updated", tooltipField:  "Updated", headerName: "Updated", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(ProjectIssueChildEditorFormComponent, config)
