  ...
  import { ProjectFeatureChildEditorFormComponent } from '../editor-form/project-feature-child-editor-form.component'
...
import { ProjectApproachChildEditorAgGridComponent } from "../../project-approach/editor-aggrid/project-approach-child-editor-aggrid.component";
  ...
  @Component({
    selector: "project-feature-child-editor-aggrid", 
templateUrl: './project-feature-child-editor-aggrid.component.html', 

styleUrls: ['./project-feature-child-editor-aggrid.component.scss'] 

}) 

  export class ProjectFeatureChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectFeatures', str, 'modal-xl')
    }
...
{ field: "Urgency", tooltipField:  "Urgency", headerName: "Urgency", flex: 1 }, 
...

{
  ...
  cellRendererParams: {
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(ProjectFeatureChildEditorFormComponent, config)
...
else if( fld == "Approach" ) return ProjectApproachChildEditorAgGridComponent
