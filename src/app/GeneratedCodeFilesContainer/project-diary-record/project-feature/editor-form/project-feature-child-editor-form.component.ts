...
import { ProjectApproachChildEditorPTableComponent } from "../../project-approach/editor-ptable/project-approach-child-editor-ptable.component";
  ...
  @Component({
    selector: "project-feature-child-editor-form", 
templateUrl: './project-feature-child-editor-form.component.html', 

styleUrls: ['./project-feature-child-editor-form.component.scss'] 

}) 

    export class ProjectFeatureChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectFeature', str, 'modal-xl')
    }
...
get Urgency() { return this.editorForm.get('Urgency')  }
...
get Approach() { return this.editorForm.get('Approach')  }
