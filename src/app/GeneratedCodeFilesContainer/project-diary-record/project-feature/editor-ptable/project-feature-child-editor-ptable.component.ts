...
import { ProjectApproachChildEditorPTableComponent } from "../../project-approach/editor-ptable/project-approach-child-editor-ptable.component";
  ...
  @Component({
    selector: "project-feature-child-editor-ptable",

templateUrl: './project-feature-child-editor-ptable.component.html', 

styleUrls: ['./project-feature-child-editor-ptable.component.scss'] 

}) 

  export class ProjectFeatureChildEditorPTableComponent implements OnInit {
...
else if( fld == "Approach" ) return ProjectApproachChildEditorPTableComponent
