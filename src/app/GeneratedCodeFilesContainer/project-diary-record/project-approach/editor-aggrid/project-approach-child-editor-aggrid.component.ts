  ...
  import { ProjectApproachChildEditorFormComponent } from '../editor-form/project-approach-child-editor-form.component'
...
import { ProjectIssueChildEditorAgGridComponent } from "../../project-issue/editor-aggrid/project-issue-child-editor-aggrid.component";
  ...
  @Component({
    selector: "project-approach-child-editor-aggrid", 
templateUrl: './project-approach-child-editor-aggrid.component.html', 

styleUrls: ['./project-approach-child-editor-aggrid.component.scss'] 

}) 

  export class ProjectApproachChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectApproaches', str, 'modal-xl')
    }
...

{
  ...
  cellRendererParams: {
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(ProjectApproachChildEditorFormComponent, config)
...
else if( fld == "Task" ) return ProjectTaskChildEditorAgGridComponent
else if( fld == "Issue" ) return ProjectIssueChildEditorAgGridComponent
