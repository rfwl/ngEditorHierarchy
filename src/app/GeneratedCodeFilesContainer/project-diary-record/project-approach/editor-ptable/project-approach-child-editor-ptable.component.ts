...
import { ProjectIssueChildEditorPTableComponent } from "../../project-issue/editor-ptable/project-issue-child-editor-ptable.component";
  ...
  @Component({
    selector: "project-approach-child-editor-ptable",

templateUrl: './project-approach-child-editor-ptable.component.html', 

styleUrls: ['./project-approach-child-editor-ptable.component.scss'] 

}) 

  export class ProjectApproachChildEditorPTableComponent implements OnInit {
...
else if( fld == "Task" ) return ProjectTaskChildEditorPTableComponent
else if( fld == "Issue" ) return ProjectIssueChildEditorPTableComponent
