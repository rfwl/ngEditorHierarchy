  ...
  import { ProjectDiaryRecord, EnumSelectorOptionSource, Enum_EditorComponent_Type } from '../../project-diary-record.model'
...
import { ProjectIssueChildEditorPTableComponent } from "../../project-issue/editor-ptable/project-issue-child-editor-ptable.component";
  ...
  @Component({
    selector: "project-approach-child-editor-form", 
templateUrl: './project-approach-child-editor-form.component.html', 

styleUrls: ['./project-approach-child-editor-form.component.scss'] 

}) 

    export class ProjectApproachChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectApproach', str, 'modal-xl')
    }
...
get Task() { return this.editorForm.get('Task')  }
get Issue() { return this.editorForm.get('Issue')  }
...
return ProjectTaskChildEditorAgGridComponent
} else if(ProjectDiaryRecord.topComponentType == Enum_EditorComponent_Type.EditorPTable){
return ProjectTaskChildEditorPTableComponent
}
}
else if( fld == "Issue" ){
if(ProjectDiaryRecord.topComponentType == Enum_EditorComponent_Type.EditorAgGrid){
return ProjectIssueChildEditorAgGridComponent
} else if(ProjectDiaryRecord.topComponentType == Enum_EditorComponent_Type.EditorPTable){
return ProjectIssueChildEditorPTableComponent
}
}
