  ...
  @Component({
    selector: "project-reference-child-editor-aggrid", 
templateUrl: './project-reference-child-editor-aggrid.component.html', 

styleUrls: ['./project-reference-child-editor-aggrid.component.scss'] 

}) 

  export class ProjectReferenceChildEditorAgGridComponent implements OnInit {
