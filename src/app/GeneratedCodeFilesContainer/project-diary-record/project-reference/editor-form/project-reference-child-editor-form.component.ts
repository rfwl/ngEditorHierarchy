  ...
  @Component({
    selector: "project-reference-child-editor-form", 
templateUrl: './project-reference-child-editor-form.component.html', 

styleUrls: ['./project-reference-child-editor-form.component.scss'] 

}) 

    export class ProjectReferenceChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectReference', str, 'modal-xl')
    }
