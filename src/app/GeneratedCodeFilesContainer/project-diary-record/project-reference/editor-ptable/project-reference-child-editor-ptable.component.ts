  ...
  import { ProjectReferenceChildEditorFormComponent } from '../editor-form/project-reference-child-editor-form.component'



  @Component({
    selector: "project-reference-child-editor-ptable",

templateUrl: './project-reference-child-editor-ptable.component.html', 

styleUrls: ['./project-reference-child-editor-ptable.component.scss'] 

}) 

  export class ProjectReferenceChildEditorPTableComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectReferences', str, 'modal-xl')
    }
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(ProjectReferenceChildEditorFormComponent, config)
    }
