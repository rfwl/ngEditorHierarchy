  ...
  @Component({
    selector: "project-task-child-editor-form", 
templateUrl: './project-task-child-editor-form.component.html', 

styleUrls: ['./project-task-child-editor-form.component.scss'] 

}) 

    export class ProjectTaskChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectTask', str, 'modal-xl')
    }
