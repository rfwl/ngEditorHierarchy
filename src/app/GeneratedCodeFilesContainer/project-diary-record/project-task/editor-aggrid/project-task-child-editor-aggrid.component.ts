  ...
  @Component({
    selector: "project-task-child-editor-aggrid", 
templateUrl: './project-task-child-editor-aggrid.component.html', 

styleUrls: ['./project-task-child-editor-aggrid.component.scss'] 

}) 

  export class ProjectTaskChildEditorAgGridComponent implements OnInit {
