  ...
  @Component({
    selector: "code-name-description-child-editor-ptable",

templateUrl: './code-name-description-child-editor-ptable.component.html', 

styleUrls: ['./code-name-description-child-editor-ptable.component.scss'] 

}) 

  export class CodeNameDescriptionChildEditorPTableComponent implements OnInit {
