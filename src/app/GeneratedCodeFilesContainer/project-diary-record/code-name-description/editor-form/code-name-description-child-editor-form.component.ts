  ...
  @Component({
    selector: "code-name-description-child-editor-form", 
templateUrl: './code-name-description-child-editor-form.component.html', 

styleUrls: ['./code-name-description-child-editor-form.component.scss'] 

}) 

    export class CodeNameDescriptionChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'CodeNameDescription', str, 'modal-xl')
    }
