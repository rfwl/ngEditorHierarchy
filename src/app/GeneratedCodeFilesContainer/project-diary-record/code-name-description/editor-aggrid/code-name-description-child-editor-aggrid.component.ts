  ...
  import { CodeNameDescriptionChildEditorFormComponent } from '../editor-form/code-name-description-child-editor-form.component'



  @Component({
    selector: "code-name-description-child-editor-aggrid", 
templateUrl: './code-name-description-child-editor-aggrid.component.html', 

styleUrls: ['./code-name-description-child-editor-aggrid.component.scss'] 

}) 

  export class CodeNameDescriptionChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'CodeNameDescriptions', str, 'modal-xl')
    }
...
{ field: "Name", tooltipField:  "Name", headerName: "Name", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(CodeNameDescriptionChildEditorFormComponent, config)
