  ...
  @Component({
    selector: "project-bug-child-editor-form", 
templateUrl: './project-bug-child-editor-form.component.html', 

styleUrls: ['./project-bug-child-editor-form.component.scss'] 

}) 

    export class ProjectBugChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectBug', str, 'modal-xl')
    }
