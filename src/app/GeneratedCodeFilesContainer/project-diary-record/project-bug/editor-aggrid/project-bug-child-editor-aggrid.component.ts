  ...
  import { ProjectBugChildEditorFormComponent } from '../editor-form/project-bug-child-editor-form.component'



  @Component({
    selector: "project-bug-child-editor-aggrid", 
templateUrl: './project-bug-child-editor-aggrid.component.html', 

styleUrls: ['./project-bug-child-editor-aggrid.component.scss'] 

}) 

  export class ProjectBugChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'ProjectBugs', str, 'modal-xl')
    }
...
{ field: "Updated", tooltipField:  "Updated", headerName: "Updated", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(ProjectBugChildEditorFormComponent, config)
