  ...
  @Component({
    selector: "project-bug-child-editor-ptable",

templateUrl: './project-bug-child-editor-ptable.component.html', 

styleUrls: ['./project-bug-child-editor-ptable.component.scss'] 

}) 

  export class ProjectBugChildEditorPTableComponent implements OnInit {
