...
import { AddressChildEditorFormComponent } from "../address/editor-form/address-child-editor-form.component";
  ...
  @Component({
    selector: "delivery-contractor-editor-aggrid", 
templateUrl: './delivery-contractor-editor-aggrid.component.html', 

styleUrls: ['./delivery-contractor-editor-aggrid.component.scss'] 

}) 

  export class DeliveryContractorEditorAgGridComponent implements OnInit {
...

{
  ...
  cellRendererParams: {
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      DeliveryContractor.topComponentType = Enum_EditorComponent_Type.EditorAgGrid
