  ...
  import { EnumSelectorOptionSource } from '../delivery-contractor.model'
...
import { AddressChildEditorFormComponent } from "../address/editor-form/address-child-editor-form.component";
  ...
  @Component({
    selector: "delivery-contractor-editor-form", 
templateUrl: './delivery-contractor-editor-form.component.html', 

styleUrls: ['./delivery-contractor-editor-form.component.scss'] 

}) 


  export class DeliveryContractorEditorFormComponent implements OnInit {
    firestore: Firestore
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'DeliveryContractor', str, 'modal-xl')
    }
    ...
    get editorFormTitle(): string{
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          return 'Create DeliveryContractor'
        case EnumEditorOperationType.Delete:
          return 'Delete DeliveryContractor'
        case EnumEditorOperationType.Update:
          return 'Update DeliveryContractor'
        default:
          return 'Edit DeliveryContractor'
      }
    }
    ...
    submitEditorForm(editorForm:any){
      ...
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          ...
          // this.store.dispatch(DeliveryContractorActionTypes.createDeliveryContractor({ deliveryContractor: {...this.editedObject } }))
          break
        case EnumEditorOperationType.Delete:
          if(this.parentDataArray && this.parentDataIndex >= 0){
            this.parentDataArray?.splice(this.parentDataIndex,1)
            // moved the next line to Editor AgGrid
            // this.store.dispatch(DeliveryContractorActionTypes.deleteDeliveryContractor({ deliveryContractorId: this.editedObject.id }))
          }
          break
        case EnumEditorOperationType.Update:
          break
