  ...
  @Component({
    selector: "correspondences-child-editor-ptable",

templateUrl: './correspondences-child-editor-ptable.component.html', 

styleUrls: ['./correspondences-child-editor-ptable.component.scss'] 

}) 

  export class CorrespondencesChildEditorPTableComponent implements OnInit {
