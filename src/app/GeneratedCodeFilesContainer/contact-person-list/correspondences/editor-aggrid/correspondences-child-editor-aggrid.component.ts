  ...
  import { CorrespondencesChildEditorFormComponent } from '../editor-form/correspondences-child-editor-form.component'



  @Component({
    selector: "correspondences-child-editor-aggrid", 
templateUrl: './correspondences-child-editor-aggrid.component.html', 

styleUrls: ['./correspondences-child-editor-aggrid.component.scss'] 

}) 

  export class CorrespondencesChildEditorAgGridComponent implements OnInit {
...
{ field: "Way", tooltipField:  "Way", headerName: "Way", flex: 1 }, 
{ field: "Venue", tooltipField:  "Venue", headerName: "Venue", flex: 1 }, 
{ field: "Datetime", tooltipField:  "Datetime", headerName: "Datetime", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(CorrespondencesChildEditorFormComponent, config)
