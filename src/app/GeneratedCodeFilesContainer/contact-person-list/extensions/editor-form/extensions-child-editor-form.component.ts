  ...
  @Component({
    selector: "extensions-child-editor-form", 
templateUrl: './extensions-child-editor-form.component.html', 

styleUrls: ['./extensions-child-editor-form.component.scss'] 

}) 

    export class ExtensionsChildEditorFormComponent implements OnInit {
...
get Type() { return this.editorForm.get('Type')  }
