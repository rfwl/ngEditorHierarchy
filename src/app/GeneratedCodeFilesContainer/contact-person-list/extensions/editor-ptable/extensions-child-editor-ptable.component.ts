  ...
  @Component({
    selector: "extensions-child-editor-ptable",

templateUrl: './extensions-child-editor-ptable.component.html', 

styleUrls: ['./extensions-child-editor-ptable.component.scss'] 

}) 

  export class ExtensionsChildEditorPTableComponent implements OnInit {
