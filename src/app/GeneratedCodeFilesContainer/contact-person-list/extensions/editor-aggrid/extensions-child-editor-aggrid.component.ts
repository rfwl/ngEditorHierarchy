  ...
  import { ExtensionsChildEditorFormComponent } from '../editor-form/extensions-child-editor-form.component'



  @Component({
    selector: "extensions-child-editor-aggrid", 
templateUrl: './extensions-child-editor-aggrid.component.html', 

styleUrls: ['./extensions-child-editor-aggrid.component.scss'] 

}) 

  export class ExtensionsChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'Extensions', str, 'modal-xl')
    }
...
{ field: "Type", tooltipField:  "Type", headerName: "Type", flex: 1 }, 
{ field: "Name", tooltipField:  "Name", headerName: "Name", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(ExtensionsChildEditorFormComponent, config)
