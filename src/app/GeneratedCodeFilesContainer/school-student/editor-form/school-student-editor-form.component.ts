  ...
  import { EnumSelectorOptionSource } from '../school-student.model'
...
import { ContactChildEditorFormComponent } from "../contact/editor-form/contact-child-editor-form.component";
  ...
  @Component({
    selector: "school-student-editor-form", 
templateUrl: './school-student-editor-form.component.html', 

styleUrls: ['./school-student-editor-form.component.scss'] 

}) 


  export class SchoolStudentEditorFormComponent implements OnInit {
    firestore: Firestore
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'SchoolStudent', str, 'modal-xl')
    }
    ...
    get editorFormTitle(): string{
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          return 'Create SchoolStudent'
        case EnumEditorOperationType.Delete:
          return 'Delete SchoolStudent'
        case EnumEditorOperationType.Update:
          return 'Update SchoolStudent'
        default:
          return 'Edit SchoolStudent'
      }
    }
    ...
    submitEditorForm(editorForm:any){
      ...
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          ...
          // this.store.dispatch(SchoolStudentActionTypes.createSchoolStudent({ schoolStudent: {...this.editedObject } }))
          break
        case EnumEditorOperationType.Delete:
          if(this.parentDataArray && this.parentDataIndex >= 0){
            this.parentDataArray?.splice(this.parentDataIndex,1)
            // moved the next line to Editor AgGrid
            // this.store.dispatch(SchoolStudentActionTypes.deleteSchoolStudent({ schoolStudentId: this.editedObject.id }))
          }
          break
        case EnumEditorOperationType.Update:
          break
