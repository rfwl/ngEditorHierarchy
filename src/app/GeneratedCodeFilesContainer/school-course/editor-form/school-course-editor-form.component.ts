  ...
  import { EnumSelectorOptionSource } from '../school-course.model'
  ...
  @Component({
    selector: "school-course-editor-form", 
templateUrl: './school-course-editor-form.component.html', 

styleUrls: ['./school-course-editor-form.component.scss'] 

}) 


  export class SchoolCourseEditorFormComponent implements OnInit {
    firestore: Firestore
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'SchoolCourse', str, 'modal-xl')
    }
    ...
    get editorFormTitle(): string{
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          return 'Create SchoolCourse'
        case EnumEditorOperationType.Delete:
          return 'Delete SchoolCourse'
        case EnumEditorOperationType.Update:
          return 'Update SchoolCourse'
        default:
          return 'Edit SchoolCourse'
      }
    }
...
get Size() { return this.editorForm.get('Size')  }
    ...
    submitEditorForm(editorForm:any){
      ...
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          ...
          // this.store.dispatch(SchoolCourseActionTypes.createSchoolCourse({ schoolCourse: {...this.editedObject } }))
          break
        case EnumEditorOperationType.Delete:
          if(this.parentDataArray && this.parentDataIndex >= 0){
            this.parentDataArray?.splice(this.parentDataIndex,1)
            // moved the next line to Editor AgGrid
            // this.store.dispatch(SchoolCourseActionTypes.deleteSchoolCourse({ schoolCourseId: this.editedObject.id }))
          }
          break
        case EnumEditorOperationType.Update:
          break
