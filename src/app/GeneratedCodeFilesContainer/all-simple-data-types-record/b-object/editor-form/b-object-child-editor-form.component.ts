  ...
  @Component({
    selector: "b-object-child-editor-form", 
templateUrl: './b-object-child-editor-form.component.html', 

styleUrls: ['./b-object-child-editor-form.component.scss'] 

}) 

    export class BObjectChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'BObject', str, 'modal-xl')
    }
...
get CString() { return this.editorForm.get('CString')  }
get CNumber() { return this.editorForm.get('CNumber')  }
get CBoolean() { return this.editorForm.get('CBoolean')  }
get CEmail() { return this.editorForm.get('CEmail')  }
get CUrl() { return this.editorForm.get('CUrl')  }
get CColor() { return this.editorForm.get('CColor')  }
get CDate() { return this.editorForm.get('CDate')  }
get CTime() { return this.editorForm.get('CTime')  }
get CDatetime() { return this.editorForm.get('CDatetime')  }
