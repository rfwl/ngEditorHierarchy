  ...
  @Component({
    selector: "b-object-child-editor-ptable",

templateUrl: './b-object-child-editor-ptable.component.html', 

styleUrls: ['./b-object-child-editor-ptable.component.scss'] 

}) 

  export class BObjectChildEditorPTableComponent implements OnInit {
