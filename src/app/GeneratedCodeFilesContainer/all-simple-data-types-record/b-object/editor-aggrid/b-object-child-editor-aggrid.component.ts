  ...
  import { BObjectChildEditorFormComponent } from '../editor-form/b-object-child-editor-form.component'
  ...
  @Component({
    selector: "b-object-child-editor-aggrid", 
templateUrl: './b-object-child-editor-aggrid.component.html', 

styleUrls: ['./b-object-child-editor-aggrid.component.scss'] 

}) 

  export class BObjectChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'BObjects', str, 'modal-xl')
    }
...
{ field: "CString", tooltipField:  "CString", headerName: "CString", flex: 1 }, 
{ field: "CNumber", tooltipField:  "CNumber", headerName: "CNumber", flex: 1 }, 
{ field: "CBoolean", tooltipField:  "CBoolean", headerName: "CBoolean", flex: 1 }, 
{ field: "CEmail", tooltipField:  "CEmail", headerName: "CEmail", flex: 1 }, 
{ field: "CUrl", tooltipField:  "CUrl", headerName: "CUrl", flex: 1 }, 
{ field: "CColor", tooltipField: "CColor", flex: 1, cellRenderer: "simpleColorCellRenderer" }, 
{ field: "CDate", tooltipField:  "CDate", headerName: "CDate", flex: 1 }, 
{ field: "CTime", tooltipField:  "CTime", headerName: "CTime", flex: 1 }, 
{ field: "CDatetime", tooltipField:  "CDatetime", headerName: "CDatetime", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(BObjectChildEditorFormComponent, config)
