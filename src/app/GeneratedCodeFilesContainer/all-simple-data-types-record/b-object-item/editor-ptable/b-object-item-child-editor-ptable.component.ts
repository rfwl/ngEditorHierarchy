  ...
  @Component({
    selector: "b-object-item-child-editor-ptable",

templateUrl: './b-object-item-child-editor-ptable.component.html', 

styleUrls: ['./b-object-item-child-editor-ptable.component.scss'] 

}) 

  export class BObjectItemChildEditorPTableComponent implements OnInit {
