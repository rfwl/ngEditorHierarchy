  ...
  @Component({
    selector: "b-object-item-child-editor-form", 
templateUrl: './b-object-item-child-editor-form.component.html', 

styleUrls: ['./b-object-item-child-editor-form.component.scss'] 

}) 

    export class BObjectItemChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'BObjectItem', str, 'modal-xl')
    }
    ...
    get editorFormTitle(): string{
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          return 'Create BObjectItem'
        case EnumEditorOperationType.Delete:
          return 'Delete BObjectItem'
        case EnumEditorOperationType.Update:
          return 'Update BObjectItem'
        default:
          return 'Edit BObjectItem'
      }
    }
...
get DString() { return this.editorForm.get('DString')  }
get DNumber() { return this.editorForm.get('DNumber')  }
get DBoolean() { return this.editorForm.get('DBoolean')  }
get DEmail() { return this.editorForm.get('DEmail')  }
get DUrl() { return this.editorForm.get('DUrl')  }
get DColor() { return this.editorForm.get('DColor')  }
get DDate() { return this.editorForm.get('DDate')  }
get DTime() { return this.editorForm.get('DTime')  }
get DDatetime() { return this.editorForm.get('DDatetime')  }
