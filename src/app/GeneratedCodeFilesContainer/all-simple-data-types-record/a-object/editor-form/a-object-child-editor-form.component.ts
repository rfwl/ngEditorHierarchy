...
import { BObjectItemChildEditorPTableComponent } from "../../b-object-item/editor-ptable/b-object-item-child-editor-ptable.component";
  ...
  @Component({
    selector: "a-object-child-editor-form", 
templateUrl: './a-object-child-editor-form.component.html', 

styleUrls: ['./a-object-child-editor-form.component.scss'] 

}) 

    export class AObjectChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'AObject', str, 'modal-xl')
    }
...
get BString() { return this.editorForm.get('BString')  }
get BNumber() { return this.editorForm.get('BNumber')  }
get BBoolean() { return this.editorForm.get('BBoolean')  }
get BEmail() { return this.editorForm.get('BEmail')  }
get BUrl() { return this.editorForm.get('BUrl')  }
get BColor() { return this.editorForm.get('BColor')  }
get BDate() { return this.editorForm.get('BDate')  }
get BTime() { return this.editorForm.get('BTime')  }
get BDatetime() { return this.editorForm.get('BDatetime')  }
get BObject() { return this.editorForm.get('BObject')  }
get BObjects() { return this.editorForm.get('BObjects')  }
