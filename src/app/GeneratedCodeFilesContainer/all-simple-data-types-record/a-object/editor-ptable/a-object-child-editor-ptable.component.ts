...
import { BObjectItemChildEditorPTableComponent } from "../../b-object-item/editor-ptable/b-object-item-child-editor-ptable.component";
  ...
  @Component({
    selector: "a-object-child-editor-ptable",

templateUrl: './a-object-child-editor-ptable.component.html', 

styleUrls: ['./a-object-child-editor-ptable.component.scss'] 

}) 

  export class AObjectChildEditorPTableComponent implements OnInit {
...
else if( fld == "BObjects" ) return BObjectItemChildEditorPTableComponent
