  ...
  import { EObjectChildEditorFormComponent } from '../editor-form/e-object-child-editor-form.component'
  ...
  @Component({
    selector: "e-object-child-editor-aggrid", 
templateUrl: './e-object-child-editor-aggrid.component.html', 

styleUrls: ['./e-object-child-editor-aggrid.component.scss'] 

}) 

  export class EObjectChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'EObjects', str, 'modal-xl')
    }
...
{ field: "FString", tooltipField:  "FString", headerName: "FString", flex: 1 }, 
{ field: "FNumber", tooltipField:  "FNumber", headerName: "FNumber", flex: 1 }, 
{ field: "FBoolean", tooltipField:  "FBoolean", headerName: "FBoolean", flex: 1 }, 
{ field: "FEmail", tooltipField:  "FEmail", headerName: "FEmail", flex: 1 }, 
{ field: "FUrl", tooltipField:  "FUrl", headerName: "FUrl", flex: 1 }, 
{ field: "FColor", tooltipField: "FColor", flex: 1, cellRenderer: "simpleColorCellRenderer" }, 
{ field: "FDate", tooltipField:  "FDate", headerName: "FDate", flex: 1 }, 
{ field: "FTime", tooltipField:  "FTime", headerName: "FTime", flex: 1 }, 
{ field: "FDatetime", tooltipField:  "FDatetime", headerName: "FDatetime", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(EObjectChildEditorFormComponent, config)
