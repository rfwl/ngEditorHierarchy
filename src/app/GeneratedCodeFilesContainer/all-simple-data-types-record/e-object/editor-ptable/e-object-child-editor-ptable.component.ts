  ...
  @Component({
    selector: "e-object-child-editor-ptable",

templateUrl: './e-object-child-editor-ptable.component.html', 

styleUrls: ['./e-object-child-editor-ptable.component.scss'] 

}) 

  export class EObjectChildEditorPTableComponent implements OnInit {
