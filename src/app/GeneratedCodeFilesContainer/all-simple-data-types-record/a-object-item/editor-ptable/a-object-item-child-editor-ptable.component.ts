...
import { EObjectItemChildEditorPTableComponent } from "../../e-object-item/editor-ptable/e-object-item-child-editor-ptable.component";
  ...
  @Component({
    selector: "a-object-item-child-editor-ptable",

templateUrl: './a-object-item-child-editor-ptable.component.html', 

styleUrls: ['./a-object-item-child-editor-ptable.component.scss'] 

}) 

  export class AObjectItemChildEditorPTableComponent implements OnInit {
...
else if( fld == "EObjects" ) return EObjectItemChildEditorPTableComponent
