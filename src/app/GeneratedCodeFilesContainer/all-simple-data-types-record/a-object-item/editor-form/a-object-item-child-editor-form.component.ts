...
import { EObjectItemChildEditorPTableComponent } from "../../e-object-item/editor-ptable/e-object-item-child-editor-ptable.component";
  ...
  @Component({
    selector: "a-object-item-child-editor-form", 
templateUrl: './a-object-item-child-editor-form.component.html', 

styleUrls: ['./a-object-item-child-editor-form.component.scss'] 

}) 

    export class AObjectItemChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'AObjectItem', str, 'modal-xl')
    }
    ...
    get editorFormTitle(): string{
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          return 'Create AObjectItem'
        case EnumEditorOperationType.Delete:
          return 'Delete AObjectItem'
        case EnumEditorOperationType.Update:
          return 'Update AObjectItem'
        default:
          return 'Edit AObjectItem'
      }
    }
...
get EString() { return this.editorForm.get('EString')  }
get ENumber() { return this.editorForm.get('ENumber')  }
get EBoolean() { return this.editorForm.get('EBoolean')  }
get EEmail() { return this.editorForm.get('EEmail')  }
get EUrl() { return this.editorForm.get('EUrl')  }
get EColor() { return this.editorForm.get('EColor')  }
get EDate() { return this.editorForm.get('EDate')  }
get ETime() { return this.editorForm.get('ETime')  }
get EDatetime() { return this.editorForm.get('EDatetime')  }
get EObject() { return this.editorForm.get('EObject')  }
get EObjects() { return this.editorForm.get('EObjects')  }
