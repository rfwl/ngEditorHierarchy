  ...
  @Component({
    selector: "e-object-item-child-editor-ptable",

templateUrl: './e-object-item-child-editor-ptable.component.html', 

styleUrls: ['./e-object-item-child-editor-ptable.component.scss'] 

}) 

  export class EObjectItemChildEditorPTableComponent implements OnInit {
