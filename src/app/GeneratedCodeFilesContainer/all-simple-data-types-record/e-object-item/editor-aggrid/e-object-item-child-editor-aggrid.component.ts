  ...
  import { EObjectItemChildEditorFormComponent } from '../editor-form/e-object-item-child-editor-form.component'
  ...
  @Component({
    selector: "e-object-item-child-editor-aggrid", 
templateUrl: './e-object-item-child-editor-aggrid.component.html', 

styleUrls: ['./e-object-item-child-editor-aggrid.component.scss'] 

}) 

  export class EObjectItemChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'EObjectItems', str, 'modal-xl')
    }
...
{ field: "GString", tooltipField:  "GString", headerName: "GString", flex: 1 }, 
{ field: "GNumber", tooltipField:  "GNumber", headerName: "GNumber", flex: 1 }, 
{ field: "GBoolean", tooltipField:  "GBoolean", headerName: "GBoolean", flex: 1 }, 
{ field: "GEmail", tooltipField:  "GEmail", headerName: "GEmail", flex: 1 }, 
{ field: "GUrl", tooltipField:  "GUrl", headerName: "GUrl", flex: 1 }, 
{ field: "GColor", tooltipField: "GColor", flex: 1, cellRenderer: "simpleColorCellRenderer" }, 
{ field: "GDate", tooltipField:  "GDate", headerName: "GDate", flex: 1 }, 
{ field: "GTime", tooltipField:  "GTime", headerName: "GTime", flex: 1 }, 
{ field: "GDatetime", tooltipField:  "GDatetime", headerName: "GDatetime", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(EObjectItemChildEditorFormComponent, config)
