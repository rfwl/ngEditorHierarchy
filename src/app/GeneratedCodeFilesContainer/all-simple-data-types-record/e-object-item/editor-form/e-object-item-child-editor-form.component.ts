  ...
  @Component({
    selector: "e-object-item-child-editor-form", 
templateUrl: './e-object-item-child-editor-form.component.html', 

styleUrls: ['./e-object-item-child-editor-form.component.scss'] 

}) 

    export class EObjectItemChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'EObjectItem', str, 'modal-xl')
    }
    ...
    get editorFormTitle(): string{
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          return 'Create EObjectItem'
        case EnumEditorOperationType.Delete:
          return 'Delete EObjectItem'
        case EnumEditorOperationType.Update:
          return 'Update EObjectItem'
        default:
          return 'Edit EObjectItem'
      }
    }
...
get GString() { return this.editorForm.get('GString')  }
get GNumber() { return this.editorForm.get('GNumber')  }
get GBoolean() { return this.editorForm.get('GBoolean')  }
get GEmail() { return this.editorForm.get('GEmail')  }
get GUrl() { return this.editorForm.get('GUrl')  }
get GColor() { return this.editorForm.get('GColor')  }
get GDate() { return this.editorForm.get('GDate')  }
get GTime() { return this.editorForm.get('GTime')  }
get GDatetime() { return this.editorForm.get('GDatetime')  }
