  ...
  import { SpecificationsChildEditorFormComponent } from '../editor-form/specifications-child-editor-form.component'



  @Component({
    selector: "specifications-child-editor-aggrid", 
templateUrl: './specifications-child-editor-aggrid.component.html', 

styleUrls: ['./specifications-child-editor-aggrid.component.scss'] 

}) 

  export class SpecificationsChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'Specifications', str, 'modal-xl')
    }
...
{ field: "Width", tooltipField:  "Width", headerName: "Width", flex: 1 }, 
{ field: "Height", tooltipField:  "Height", headerName: "Height", flex: 1 }, 
{ field: "Depth", tooltipField:  "Depth", headerName: "Depth", flex: 1 }, 
{ field: "Weight", tooltipField:  "Weight", headerName: "Weight", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(SpecificationsChildEditorFormComponent, config)
