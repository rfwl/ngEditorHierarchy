  ...
  @Component({
    selector: "specifications-child-editor-ptable",

templateUrl: './specifications-child-editor-ptable.component.html', 

styleUrls: ['./specifications-child-editor-ptable.component.scss'] 

}) 

  export class SpecificationsChildEditorPTableComponent implements OnInit {
