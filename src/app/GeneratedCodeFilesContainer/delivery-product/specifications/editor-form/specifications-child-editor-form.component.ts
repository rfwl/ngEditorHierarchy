  ...
  import { DeliveryProduct, EnumSelectorOptionSource, Enum_EditorComponent_Type } from '../../delivery-product.model'
  ...
  @Component({
    selector: "specifications-child-editor-form", 
templateUrl: './specifications-child-editor-form.component.html', 

styleUrls: ['./specifications-child-editor-form.component.scss'] 

}) 

    export class SpecificationsChildEditorFormComponent implements OnInit {
...
get Width() { return this.editorForm.get('Width')  }
get Height() { return this.editorForm.get('Height')  }
get Depth() { return this.editorForm.get('Depth')  }
get Weight() { return this.editorForm.get('Weight')  }
