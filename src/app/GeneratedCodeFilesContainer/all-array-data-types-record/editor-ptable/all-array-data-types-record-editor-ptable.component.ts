...
import { AArrayItemChildEditorPTableComponent } from "../a-array-item/editor-ptable/a-array-item-child-editor-ptable.component";
  ...
  @Component({
    selector: "all-array-data-types-record-editor-ptable",

templateUrl: './all-array-data-types-record-editor-ptable.component.html', 

styleUrls: ['./all-array-data-types-record-editor-ptable.component.scss'] 

}) 

  export class AllArrayDataTypesRecordEditorPTableComponent implements OnInit {
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      AllArrayDataTypesRecord.topComponentType = Enum_EditorComponent_Type.EditorPTable
    }
...
else if( fld == "AArrays" ) return AArrayItemChildEditorPTableComponent
