  ...
  @Component({
    selector: "a-array-item-child-editor-form", 
templateUrl: './a-array-item-child-editor-form.component.html', 

styleUrls: ['./a-array-item-child-editor-form.component.scss'] 

}) 

    export class AArrayItemChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'AArrayItem', str, 'modal-xl')
    }
    ...
    get editorFormTitle(): string{
      switch(this.editorOperationType){
        case EnumEditorOperationType.Create:
          return 'Create AArrayItem'
        case EnumEditorOperationType.Delete:
          return 'Delete AArrayItem'
        case EnumEditorOperationType.Update:
          return 'Update AArrayItem'
        default:
          return 'Edit AArrayItem'
      }
    }
...
get CStrings() { return this.editorForm.get('CStrings')  }
get CNumbers() { return this.editorForm.get('CNumbers')  }
get CBooleans() { return this.editorForm.get('CBooleans')  }
get CEmails() { return this.editorForm.get('CEmails')  }
get CUrls() { return this.editorForm.get('CUrls')  }
get CColors() { return this.editorForm.get('CColors')  }
get CDates() { return this.editorForm.get('CDates')  }
get CTimes() { return this.editorForm.get('CTimes')  }
get CDatetimes() { return this.editorForm.get('CDatetimes')  }
