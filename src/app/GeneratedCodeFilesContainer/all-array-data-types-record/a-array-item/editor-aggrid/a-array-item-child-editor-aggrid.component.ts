  ...
  import { AArrayItemChildEditorFormComponent } from '../editor-form/a-array-item-child-editor-form.component'
  ...
  @Component({
    selector: "a-array-item-child-editor-aggrid", 
templateUrl: './a-array-item-child-editor-aggrid.component.html', 

styleUrls: ['./a-array-item-child-editor-aggrid.component.scss'] 

}) 

  export class AArrayItemChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'AArrayItems', str, 'modal-xl')
    }
...
cellRenderer: "dataTypeArrayCellRenderer", cellRendererParams: { inputType: "datetime-local" } }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(AArrayItemChildEditorFormComponent, config)
