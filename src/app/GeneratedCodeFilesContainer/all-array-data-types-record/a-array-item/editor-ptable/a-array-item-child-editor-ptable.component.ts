  ...
  @Component({
    selector: "a-array-item-child-editor-ptable",

templateUrl: './a-array-item-child-editor-ptable.component.html', 

styleUrls: ['./a-array-item-child-editor-ptable.component.scss'] 

}) 

  export class AArrayItemChildEditorPTableComponent implements OnInit {
