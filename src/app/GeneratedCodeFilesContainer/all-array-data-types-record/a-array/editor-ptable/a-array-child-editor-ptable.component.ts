  ...
  @Component({
    selector: "a-array-child-editor-ptable",

templateUrl: './a-array-child-editor-ptable.component.html', 

styleUrls: ['./a-array-child-editor-ptable.component.scss'] 

}) 

  export class AArrayChildEditorPTableComponent implements OnInit {
