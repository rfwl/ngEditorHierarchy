  ...
  import { AArrayChildEditorFormComponent } from '../editor-form/a-array-child-editor-form.component'
  ...
  @Component({
    selector: "a-array-child-editor-aggrid", 
templateUrl: './a-array-child-editor-aggrid.component.html', 

styleUrls: ['./a-array-child-editor-aggrid.component.scss'] 

}) 

  export class AArrayChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'AArrays', str, 'modal-xl')
    }
...
cellRenderer: "dataTypeArrayCellRenderer", cellRendererParams: { inputType: "datetime-local" } }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(AArrayChildEditorFormComponent, config)
